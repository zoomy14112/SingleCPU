...
REM
REM Generated by Vivado on Mon Mar 30 22:53:44 +0800 2026
...
echo "xvlog --incr --relax -prj simulate_vlog.prj"
call xvlog  --incr --relax -prj simulate_vlog.prj -log xvlog.log

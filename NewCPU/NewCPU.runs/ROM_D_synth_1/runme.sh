...
HD_PWD='G:/system/NewCPU/NewCPU.runs/ROM_D_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_D.tcl

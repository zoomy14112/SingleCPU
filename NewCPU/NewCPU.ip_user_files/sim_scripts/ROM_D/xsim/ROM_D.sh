...
#
# Script generated by Vivado on Fri Mar 13 14:15:07 +0800 2026
...
#
# Usage        : ROM_D.sh
#                ROM_D.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROM_D.sh [-reset_run]
#                ROM_D.sh [-reset_log]
#                ROM_D.sh [-help]
#
...
# script info
echo -e "ROM_D.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROM_D.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_D xil_defaultlib.ROM_D xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROM_D -key {Behavioral:sim_1:Functional:ROM_D} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROM_D.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROM_D.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROM_D.sh [-help]\n\
Usage: ROM_D.sh [-step]\n\
Usage: ROM_D.sh [-lib_map_path]\n\
Usage: ROM_D.sh [-reset_run]\n\
Usage: ROM_D.sh [-reset_log]\n\
Usage: ROM_D.sh [-keep_index]\n\
Usage: ROM_D.sh [-noclean_files]\n\n\

...
#
# Script generated by Vivado on Fri Mar 13 14:18:08 +0800 2026
...
#
# Usage        : RAM_B.sh
#                RAM_B.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RAM_B.sh [-reset_run]
#                RAM_B.sh [-reset_log]
#                RAM_B.sh [-help]
#
...
# script info
echo -e "RAM_B.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RAM_B.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_B xil_defaultlib.RAM_B xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RAM_B.wdb xsim.dir libdpi.so)
...
Usage: RAM_B.sh [-reset_log]\n\
Usage: RAM_B.sh [-keep_index]\n\
